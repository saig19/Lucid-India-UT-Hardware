...
vlog -work work ttlclk_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax ttlclk_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.ttlclk_tb work.glbl
