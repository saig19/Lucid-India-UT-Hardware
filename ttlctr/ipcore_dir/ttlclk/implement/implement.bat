...
xst -ifn xst.scr
move ttlclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ttlclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ttlclk_exdes.ucf ttlclk_exdes

echo 'Running map'
map -timing -pr b ttlclk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ttlclk_exdes -w routed.ncd routed.v
cd ..
